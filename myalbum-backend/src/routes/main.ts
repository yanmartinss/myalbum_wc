...
routes.get(
  ...
  authMiddleware,
  userController.getCollectionGroups,
);
...
routes.patch(
  ...
  authMiddleware,
  collectionController.increment,
);
routes.patch(
  "/collection/decrement",
  authMiddleware,
  collectionController.decrement,
);
...
routes.get("/album/shared/:userId", collectionController.getSharedAlbum);
